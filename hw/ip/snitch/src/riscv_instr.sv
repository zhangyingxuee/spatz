...
package riscv_instr;
  ...
  localparam logic [31:0] C_SRLI_RV32        = 32'b????????????????100000????????01;
  localparam logic [31:0] C_SRAI_RV32        = 32'b????????????????100001????????01;
  localparam logic [31:0] C_SLLI_RV32        = 32'b????????????????0000??????????10;
  ...
  localparam logic [31:0] C_LD               = 32'b????????????????011???????????00;
  localparam logic [31:0] C_SD               = 32'b????????????????111???????????00;
  localparam logic [31:0] C_SUBW             = 32'b????????????????100111???00???01;
  localparam logic [31:0] C_ADDW             = 32'b????????????????100111???01???01;
  localparam logic [31:0] C_ADDIW            = 32'b????????????????001???????????01;
  localparam logic [31:0] C_LDSP             = 32'b????????????????011???????????10;
  localparam logic [31:0] C_SDSP             = 32'b????????????????111???????????10;
  ...
  localparam logic [31:0] VLM_V              = 32'b000000101011?????000?????0000111;
  localparam logic [31:0] VSM_V              = 32'b000000101011?????000?????0100111;
  localparam logic [31:0] VLE8_V             = 32'b???000?00000?????000?????0000111;
  localparam logic [31:0] VLE16_V            = 32'b???000?00000?????101?????0000111;
  localparam logic [31:0] VLE32_V            = 32'b???000?00000?????110?????0000111;
  localparam logic [31:0] VLE64_V            = 32'b???000?00000?????111?????0000111;
  localparam logic [31:0] VLE128_V           = 32'b???100?00000?????000?????0000111;
  localparam logic [31:0] VLE256_V           = 32'b???100?00000?????101?????0000111;
  localparam logic [31:0] VLE512_V           = 32'b???100?00000?????110?????0000111;
  localparam logic [31:0] VLE1024_V          = 32'b???100?00000?????111?????0000111;
  localparam logic [31:0] VSE8_V             = 32'b???000?00000?????000?????0100111;
  localparam logic [31:0] VSE16_V            = 32'b???000?00000?????101?????0100111;
  localparam logic [31:0] VSE32_V            = 32'b???000?00000?????110?????0100111;
  localparam logic [31:0] VSE64_V            = 32'b???000?00000?????111?????0100111;
  localparam logic [31:0] VSE128_V           = 32'b???100?00000?????000?????0100111;
  localparam logic [31:0] VSE256_V           = 32'b???100?00000?????101?????0100111;
  localparam logic [31:0] VSE512_V           = 32'b???100?00000?????110?????0100111;
  localparam logic [31:0] VSE1024_V          = 32'b???100?00000?????111?????0100111;
  localparam logic [31:0] VLUXEI8_V          = 32'b???001???????????000?????0000111;
  localparam logic [31:0] VLUXEI16_V         = 32'b???001???????????101?????0000111;
  localparam logic [31:0] VLUXEI32_V         = 32'b???001???????????110?????0000111;
  localparam logic [31:0] VLUXEI64_V         = 32'b???001???????????111?????0000111;
  localparam logic [31:0] VLUXEI128_V        = 32'b???101???????????000?????0000111;
  localparam logic [31:0] VLUXEI256_V        = 32'b???101???????????101?????0000111;
  localparam logic [31:0] VLUXEI512_V        = 32'b???101???????????110?????0000111;
  localparam logic [31:0] VLUXEI1024_V       = 32'b???101???????????111?????0000111;
  localparam logic [31:0] VSUXEI8_V          = 32'b???001???????????000?????0100111;
  localparam logic [31:0] VSUXEI16_V         = 32'b???001???????????101?????0100111;
  localparam logic [31:0] VSUXEI32_V         = 32'b???001???????????110?????0100111;
  localparam logic [31:0] VSUXEI64_V         = 32'b???001???????????111?????0100111;
  localparam logic [31:0] VSUXEI128_V        = 32'b???101???????????000?????0100111;
  localparam logic [31:0] VSUXEI256_V        = 32'b???101???????????101?????0100111;
  localparam logic [31:0] VSUXEI512_V        = 32'b???101???????????110?????0100111;
  localparam logic [31:0] VSUXEI1024_V       = 32'b???101???????????111?????0100111;
  localparam logic [31:0] VLSE8_V            = 32'b???010???????????000?????0000111;
  localparam logic [31:0] VLSE16_V           = 32'b???010???????????101?????0000111;
  localparam logic [31:0] VLSE32_V           = 32'b???010???????????110?????0000111;
  localparam logic [31:0] VLSE64_V           = 32'b???010???????????111?????0000111;
  localparam logic [31:0] VLSE128_V          = 32'b???110???????????000?????0000111;
  localparam logic [31:0] VLSE256_V          = 32'b???110???????????101?????0000111;
  localparam logic [31:0] VLSE512_V          = 32'b???110???????????110?????0000111;
  localparam logic [31:0] VLSE1024_V         = 32'b???110???????????111?????0000111;
  localparam logic [31:0] VSSE8_V            = 32'b???010???????????000?????0100111;
  localparam logic [31:0] VSSE16_V           = 32'b???010???????????101?????0100111;
  localparam logic [31:0] VSSE32_V           = 32'b???010???????????110?????0100111;
  localparam logic [31:0] VSSE64_V           = 32'b???010???????????111?????0100111;
  localparam logic [31:0] VSSE128_V          = 32'b???110???????????000?????0100111;
  localparam logic [31:0] VSSE256_V          = 32'b???110???????????101?????0100111;
  localparam logic [31:0] VSSE512_V          = 32'b???110???????????110?????0100111;
  localparam logic [31:0] VSSE1024_V         = 32'b???110???????????111?????0100111;
  localparam logic [31:0] VLOXEI8_V          = 32'b???011???????????000?????0000111;
  localparam logic [31:0] VLOXEI16_V         = 32'b???011???????????101?????0000111;
  localparam logic [31:0] VLOXEI32_V         = 32'b???011???????????110?????0000111;
  localparam logic [31:0] VLOXEI64_V         = 32'b???011???????????111?????0000111;
  localparam logic [31:0] VLOXEI128_V        = 32'b???111???????????000?????0000111;
  localparam logic [31:0] VLOXEI256_V        = 32'b???111???????????101?????0000111;
  localparam logic [31:0] VLOXEI512_V        = 32'b???111???????????110?????0000111;
  localparam logic [31:0] VLOXEI1024_V       = 32'b???111???????????111?????0000111;
  localparam logic [31:0] VSOXEI8_V          = 32'b???011???????????000?????0100111;
  localparam logic [31:0] VSOXEI16_V         = 32'b???011???????????101?????0100111;
  localparam logic [31:0] VSOXEI32_V         = 32'b???011???????????110?????0100111;
  localparam logic [31:0] VSOXEI64_V         = 32'b???011???????????111?????0100111;
  localparam logic [31:0] VSOXEI128_V        = 32'b???111???????????000?????0100111;
  localparam logic [31:0] VSOXEI256_V        = 32'b???111???????????101?????0100111;
  localparam logic [31:0] VSOXEI512_V        = 32'b???111???????????110?????0100111;
  localparam logic [31:0] VSOXEI1024_V       = 32'b???111???????????111?????0100111;
  localparam logic [31:0] VLE8FF_V           = 32'b???000?10000?????000?????0000111;
  localparam logic [31:0] VLE16FF_V          = 32'b???000?10000?????101?????0000111;
  localparam logic [31:0] VLE32FF_V          = 32'b???000?10000?????110?????0000111;
  localparam logic [31:0] VLE64FF_V          = 32'b???000?10000?????111?????0000111;
  localparam logic [31:0] VLE128FF_V         = 32'b???100?10000?????000?????0000111;
  localparam logic [31:0] VLE256FF_V         = 32'b???100?10000?????101?????0000111;
  localparam logic [31:0] VLE512FF_V         = 32'b???100?10000?????110?????0000111;
  localparam logic [31:0] VLE1024FF_V        = 32'b???100?10000?????111?????0000111;
  localparam logic [31:0] VL1RE8_V           = 32'b000000101000?????000?????0000111;
  localparam logic [31:0] VL1RE16_V          = 32'b000000101000?????101?????0000111;
  localparam logic [31:0] VL1RE32_V          = 32'b000000101000?????110?????0000111;
  localparam logic [31:0] VL1RE64_V          = 32'b000000101000?????111?????0000111;
  localparam logic [31:0] VL2RE8_V           = 32'b001000101000?????000?????0000111;
  localparam logic [31:0] VL2RE16_V          = 32'b001000101000?????101?????0000111;
  localparam logic [31:0] VL2RE32_V          = 32'b001000101000?????110?????0000111;
  localparam logic [31:0] VL2RE64_V          = 32'b001000101000?????111?????0000111;
  localparam logic [31:0] VL4RE8_V           = 32'b011000101000?????000?????0000111;
  localparam logic [31:0] VL4RE16_V          = 32'b011000101000?????101?????0000111;
  localparam logic [31:0] VL4RE32_V          = 32'b011000101000?????110?????0000111;
  localparam logic [31:0] VL4RE64_V          = 32'b011000101000?????111?????0000111;
  localparam logic [31:0] VL8RE8_V           = 32'b111000101000?????000?????0000111;
  localparam logic [31:0] VL8RE16_V          = 32'b111000101000?????101?????0000111;
  localparam logic [31:0] VL8RE32_V          = 32'b111000101000?????110?????0000111;
  localparam logic [31:0] VL8RE64_V          = 32'b111000101000?????111?????0000111;
  localparam logic [31:0] VS1R_V             = 32'b000000101000?????000?????0100111;
  localparam logic [31:0] VS2R_V             = 32'b001000101000?????000?????0100111;
  localparam logic [31:0] VS4R_V             = 32'b011000101000?????000?????0100111;
  localparam logic [31:0] VS8R_V             = 32'b111000101000?????000?????0100111;
  localparam logic [31:0] VFADD_VF           = 32'b000000???????????101?????1010111;
  localparam logic [31:0] VFSUB_VF           = 32'b000010???????????101?????1010111;
  localparam logic [31:0] VFMIN_VF           = 32'b000100???????????101?????1010111;
  localparam logic [31:0] VFMAX_VF           = 32'b000110???????????101?????1010111;
  localparam logic [31:0] VFSGNJ_VF          = 32'b001000???????????101?????1010111;
  localparam logic [31:0] VFSGNJN_VF         = 32'b001001???????????101?????1010111;
  localparam logic [31:0] VFSGNJX_VF         = 32'b001010???????????101?????1010111;
  localparam logic [31:0] VFSLIDE1UP_VF      = 32'b001110???????????101?????1010111;
  localparam logic [31:0] VFSLIDE1DOWN_VF    = 32'b001111???????????101?????1010111;
  localparam logic [31:0] VFMV_S_F           = 32'b010000100000?????101?????1010111;
  localparam logic [31:0] VFMERGE_VFM        = 32'b0101110??????????101?????1010111;
  localparam logic [31:0] VFMV_V_F           = 32'b010111100000?????101?????1010111;
  localparam logic [31:0] VMFEQ_VF           = 32'b011000???????????101?????1010111;
  localparam logic [31:0] VMFLE_VF           = 32'b011001???????????101?????1010111;
  localparam logic [31:0] VMFLT_VF           = 32'b011011???????????101?????1010111;
  localparam logic [31:0] VMFNE_VF           = 32'b011100???????????101?????1010111;
  localparam logic [31:0] VMFGT_VF           = 32'b011101???????????101?????1010111;
  localparam logic [31:0] VMFGE_VF           = 32'b011111???????????101?????1010111;
  localparam logic [31:0] VFDIV_VF           = 32'b100000???????????101?????1010111;
  localparam logic [31:0] VFRDIV_VF          = 32'b100001???????????101?????1010111;
  localparam logic [31:0] VFMUL_VF           = 32'b100100???????????101?????1010111;
  localparam logic [31:0] VFRSUB_VF          = 32'b100111???????????101?????1010111;
  localparam logic [31:0] VFMADD_VF          = 32'b101000???????????101?????1010111;
  localparam logic [31:0] VFNMADD_VF         = 32'b101001???????????101?????1010111;
  localparam logic [31:0] VFMSUB_VF          = 32'b101010???????????101?????1010111;
  localparam logic [31:0] VFNMSUB_VF         = 32'b101011???????????101?????1010111;
  localparam logic [31:0] VFMACC_VF          = 32'b101100???????????101?????1010111;
  localparam logic [31:0] VFNMACC_VF         = 32'b101101???????????101?????1010111;
  localparam logic [31:0] VFMSAC_VF          = 32'b101110???????????101?????1010111;
  localparam logic [31:0] VFNMSAC_VF         = 32'b101111???????????101?????1010111;
  localparam logic [31:0] VFWADD_VF          = 32'b110000???????????101?????1010111;
  localparam logic [31:0] VFWSUB_VF          = 32'b110010???????????101?????1010111;
  localparam logic [31:0] VFWADD_WF          = 32'b110100???????????101?????1010111;
  localparam logic [31:0] VFWSUB_WF          = 32'b110110???????????101?????1010111;
  localparam logic [31:0] VFWMUL_VF          = 32'b111000???????????101?????1010111;
  localparam logic [31:0] VFWDOTP_VF         = 32'b111011???????????101?????1010111;
  localparam logic [31:0] VFWMACC_VF         = 32'b111100???????????101?????1010111;
  localparam logic [31:0] VFWNMACC_VF        = 32'b111101???????????101?????1010111;
  localparam logic [31:0] VFWMSAC_VF         = 32'b111110???????????101?????1010111;
  localparam logic [31:0] VFWNMSAC_VF        = 32'b111111???????????101?????1010111;
  localparam logic [31:0] VFADD_VV           = 32'b000000???????????001?????1010111;
  localparam logic [31:0] VFREDUSUM_VS       = 32'b000001???????????001?????1010111;
  localparam logic [31:0] VFSUB_VV           = 32'b000010???????????001?????1010111;
  localparam logic [31:0] VFREDOSUM_VS       = 32'b000011???????????001?????1010111;
  localparam logic [31:0] VFMIN_VV           = 32'b000100???????????001?????1010111;
  localparam logic [31:0] VFREDMIN_VS        = 32'b000101???????????001?????1010111;
  localparam logic [31:0] VFMAX_VV           = 32'b000110???????????001?????1010111;
  localparam logic [31:0] VFREDMAX_VS        = 32'b000111???????????001?????1010111;
  localparam logic [31:0] VFSGNJ_VV          = 32'b001000???????????001?????1010111;
  localparam logic [31:0] VFSGNJN_VV         = 32'b001001???????????001?????1010111;
  localparam logic [31:0] VFSGNJX_VV         = 32'b001010???????????001?????1010111;
  localparam logic [31:0] VFMV_F_S           = 32'b0100001?????00000001?????1010111;
  localparam logic [31:0] VMFEQ_VV           = 32'b011000???????????001?????1010111;
  localparam logic [31:0] VMFLE_VV           = 32'b011001???????????001?????1010111;
  localparam logic [31:0] VMFLT_VV           = 32'b011011???????????001?????1010111;
  localparam logic [31:0] VMFNE_VV           = 32'b011100???????????001?????1010111;
  localparam logic [31:0] VFDIV_VV           = 32'b100000???????????001?????1010111;
  localparam logic [31:0] VFMUL_VV           = 32'b100100???????????001?????1010111;
  localparam logic [31:0] VFMADD_VV          = 32'b101000???????????001?????1010111;
  localparam logic [31:0] VFNMADD_VV         = 32'b101001???????????001?????1010111;
  localparam logic [31:0] VFMSUB_VV          = 32'b101010???????????001?????1010111;
  localparam logic [31:0] VFNMSUB_VV         = 32'b101011???????????001?????1010111;
  localparam logic [31:0] VFMACC_VV          = 32'b101100???????????001?????1010111;
  localparam logic [31:0] VFNMACC_VV         = 32'b101101???????????001?????1010111;
  localparam logic [31:0] VFMSAC_VV          = 32'b101110???????????001?????1010111;
  localparam logic [31:0] VFNMSAC_VV         = 32'b101111???????????001?????1010111;
  localparam logic [31:0] VFCVT_XU_F_V       = 32'b010010??????00000001?????1010111;
  localparam logic [31:0] VFCVT_X_F_V        = 32'b010010??????00001001?????1010111;
  localparam logic [31:0] VFCVT_F_XU_V       = 32'b010010??????00010001?????1010111;
  localparam logic [31:0] VFCVT_F_X_V        = 32'b010010??????00011001?????1010111;
  localparam logic [31:0] VFCVT_RTZ_XU_F_V   = 32'b010010??????00110001?????1010111;
  localparam logic [31:0] VFCVT_RTZ_X_F_V    = 32'b010010??????00111001?????1010111;
  localparam logic [31:0] VFWCVT_XU_F_V      = 32'b010010??????01000001?????1010111;
  localparam logic [31:0] VFWCVT_X_F_V       = 32'b010010??????01001001?????1010111;
  localparam logic [31:0] VFWCVT_F_XU_V      = 32'b010010??????01010001?????1010111;
  localparam logic [31:0] VFWCVT_F_X_V       = 32'b010010??????01011001?????1010111;
  localparam logic [31:0] VFWCVT_F_F_V       = 32'b010010??????01100001?????1010111;
  localparam logic [31:0] VFWCVT_RTZ_XU_F_V  = 32'b010010??????01110001?????1010111;
  localparam logic [31:0] VFWCVT_RTZ_X_F_V   = 32'b010010??????01111001?????1010111;
  localparam logic [31:0] VFNCVT_XU_F_W      = 32'b010010??????10000001?????1010111;
  localparam logic [31:0] VFNCVT_X_F_W       = 32'b010010??????10001001?????1010111;
  localparam logic [31:0] VFNCVT_F_XU_W      = 32'b010010??????10010001?????1010111;
  localparam logic [31:0] VFNCVT_F_X_W       = 32'b010010??????10011001?????1010111;
  localparam logic [31:0] VFNCVT_F_F_W       = 32'b010010??????10100001?????1010111;
  localparam logic [31:0] VFNCVT_ROD_F_F_W   = 32'b010010??????10101001?????1010111;
  localparam logic [31:0] VFNCVT_RTZ_XU_F_W  = 32'b010010??????10110001?????1010111;
  localparam logic [31:0] VFNCVT_RTZ_X_F_W   = 32'b010010??????10111001?????1010111;
  localparam logic [31:0] VFSQRT_V           = 32'b010011??????00000001?????1010111;
  ...
  localparam logic [31:0] VFWREDOSUM_VS      = 32'b110011???????????001?????1010111;
  localparam logic [31:0] VFWADD_WV          = 32'b110100???????????001?????1010111;
  localparam logic [31:0] VFWSUB_WV          = 32'b110110???????????001?????1010111;
  localparam logic [31:0] VFWMUL_VV          = 32'b111000???????????001?????1010111;
  localparam logic [31:0] VFWDOTP_VV         = 32'b111011???????????001?????1010111;
  localparam logic [31:0] VFWMACC_VV         = 32'b111100???????????001?????1010111;
  localparam logic [31:0] VFWNMACC_VV        = 32'b111101???????????001?????1010111;
  localparam logic [31:0] VFWMSAC_VV         = 32'b111110???????????001?????1010111;
  localparam logic [31:0] VFWNMSAC_VV        = 32'b111111???????????001?????1010111;
  localparam logic [31:0] VADD_VX            = 32'b000000???????????100?????1010111;
  localparam logic [31:0] VSUB_VX            = 32'b000010???????????100?????1010111;
  localparam logic [31:0] VRSUB_VX           = 32'b000011???????????100?????1010111;
  localparam logic [31:0] VMINU_VX           = 32'b000100???????????100?????1010111;
  localparam logic [31:0] VMIN_VX            = 32'b000101???????????100?????1010111;
  localparam logic [31:0] VMAXU_VX           = 32'b000110???????????100?????1010111;
  localparam logic [31:0] VMAX_VX            = 32'b000111???????????100?????1010111;
  localparam logic [31:0] VAND_VX            = 32'b001001???????????100?????1010111;
  localparam logic [31:0] VOR_VX             = 32'b001010???????????100?????1010111;
  localparam logic [31:0] VXOR_VX            = 32'b001011???????????100?????1010111;
  localparam logic [31:0] VRGATHER_VX        = 32'b001100???????????100?????1010111;
  localparam logic [31:0] VSLIDEUP_VX        = 32'b001110???????????100?????1010111;
  localparam logic [31:0] VSLIDEDOWN_VX      = 32'b001111???????????100?????1010111;
  localparam logic [31:0] VADC_VXM           = 32'b0100000??????????100?????1010111;
  localparam logic [31:0] VMADC_VXM          = 32'b0100010??????????100?????1010111;
  localparam logic [31:0] VMADC_VX           = 32'b0100011??????????100?????1010111;
  localparam logic [31:0] VSBC_VXM           = 32'b0100100??????????100?????1010111;
  localparam logic [31:0] VMSBC_VXM          = 32'b0100110??????????100?????1010111;
  localparam logic [31:0] VMSBC_VX           = 32'b0100111??????????100?????1010111;
  localparam logic [31:0] VMERGE_VXM         = 32'b0101110??????????100?????1010111;
  localparam logic [31:0] VMV_V_X            = 32'b010111100000?????100?????1010111;
  localparam logic [31:0] VMSEQ_VX           = 32'b011000???????????100?????1010111;
  localparam logic [31:0] VMSNE_VX           = 32'b011001???????????100?????1010111;
  localparam logic [31:0] VMSLTU_VX          = 32'b011010???????????100?????1010111;
  localparam logic [31:0] VMSLT_VX           = 32'b011011???????????100?????1010111;
  localparam logic [31:0] VMSLEU_VX          = 32'b011100???????????100?????1010111;
  localparam logic [31:0] VMSLE_VX           = 32'b011101???????????100?????1010111;
  localparam logic [31:0] VMSGTU_VX          = 32'b011110???????????100?????1010111;
  localparam logic [31:0] VMSGT_VX           = 32'b011111???????????100?????1010111;
  localparam logic [31:0] VSADDU_VX          = 32'b100000???????????100?????1010111;
  localparam logic [31:0] VSADD_VX           = 32'b100001???????????100?????1010111;
  localparam logic [31:0] VSSUBU_VX          = 32'b100010???????????100?????1010111;
  localparam logic [31:0] VSSUB_VX           = 32'b100011???????????100?????1010111;
  localparam logic [31:0] VSLL_VX            = 32'b100101???????????100?????1010111;
  localparam logic [31:0] VSMUL_VX           = 32'b100111???????????100?????1010111;
  localparam logic [31:0] VSRL_VX            = 32'b101000???????????100?????1010111;
  localparam logic [31:0] VSRA_VX            = 32'b101001???????????100?????1010111;
  localparam logic [31:0] VSSRL_VX           = 32'b101010???????????100?????1010111;
  localparam logic [31:0] VSSRA_VX           = 32'b101011???????????100?????1010111;
  localparam logic [31:0] VNSRL_WX           = 32'b101100???????????100?????1010111;
  localparam logic [31:0] VNSRA_WX           = 32'b101101???????????100?????1010111;
  localparam logic [31:0] VNCLIPU_WX         = 32'b101110???????????100?????1010111;
  localparam logic [31:0] VNCLIP_WX          = 32'b101111???????????100?????1010111;
  localparam logic [31:0] VADD_VV            = 32'b000000???????????000?????1010111;
  localparam logic [31:0] VSUB_VV            = 32'b000010???????????000?????1010111;
  localparam logic [31:0] VMINU_VV           = 32'b000100???????????000?????1010111;
  localparam logic [31:0] VMIN_VV            = 32'b000101???????????000?????1010111;
  localparam logic [31:0] VMAXU_VV           = 32'b000110???????????000?????1010111;
  localparam logic [31:0] VMAX_VV            = 32'b000111???????????000?????1010111;
  localparam logic [31:0] VAND_VV            = 32'b001001???????????000?????1010111;
  localparam logic [31:0] VOR_VV             = 32'b001010???????????000?????1010111;
  localparam logic [31:0] VXOR_VV            = 32'b001011???????????000?????1010111;
  localparam logic [31:0] VRGATHER_VV        = 32'b001100???????????000?????1010111;
  localparam logic [31:0] VRGATHEREI16_VV    = 32'b001110???????????000?????1010111;
  localparam logic [31:0] VADC_VVM           = 32'b0100000??????????000?????1010111;
  localparam logic [31:0] VMADC_VVM          = 32'b0100010??????????000?????1010111;
  localparam logic [31:0] VMADC_VV           = 32'b0100011??????????000?????1010111;
  localparam logic [31:0] VSBC_VVM           = 32'b0100100??????????000?????1010111;
  localparam logic [31:0] VMSBC_VVM          = 32'b0100110??????????000?????1010111;
  localparam logic [31:0] VMSBC_VV           = 32'b0100111??????????000?????1010111;
  localparam logic [31:0] VMERGE_VVM         = 32'b0101110??????????000?????1010111;
  localparam logic [31:0] VMV_V_V            = 32'b010111100000?????000?????1010111;
  localparam logic [31:0] VMSEQ_VV           = 32'b011000???????????000?????1010111;
  localparam logic [31:0] VMSNE_VV           = 32'b011001???????????000?????1010111;
  localparam logic [31:0] VMSLTU_VV          = 32'b011010???????????000?????1010111;
  localparam logic [31:0] VMSLT_VV           = 32'b011011???????????000?????1010111;
  localparam logic [31:0] VMSLEU_VV          = 32'b011100???????????000?????1010111;
  localparam logic [31:0] VMSLE_VV           = 32'b011101???????????000?????1010111;
  localparam logic [31:0] VSADDU_VV          = 32'b100000???????????000?????1010111;
  localparam logic [31:0] VSADD_VV           = 32'b100001???????????000?????1010111;
  localparam logic [31:0] VSSUBU_VV          = 32'b100010???????????000?????1010111;
  localparam logic [31:0] VSSUB_VV           = 32'b100011???????????000?????1010111;
  localparam logic [31:0] VSLL_VV            = 32'b100101???????????000?????1010111;
  localparam logic [31:0] VSMUL_VV           = 32'b100111???????????000?????1010111;
  localparam logic [31:0] VSRL_VV            = 32'b101000???????????000?????1010111;
  localparam logic [31:0] VSRA_VV            = 32'b101001???????????000?????1010111;
  localparam logic [31:0] VSSRL_VV           = 32'b101010???????????000?????1010111;
  localparam logic [31:0] VSSRA_VV           = 32'b101011???????????000?????1010111;
  localparam logic [31:0] VNSRL_WV           = 32'b101100???????????000?????1010111;
  localparam logic [31:0] VNSRA_WV           = 32'b101101???????????000?????1010111;
  localparam logic [31:0] VNCLIPU_WV         = 32'b101110???????????000?????1010111;
  localparam logic [31:0] VNCLIP_WV          = 32'b101111???????????000?????1010111;
  localparam logic [31:0] VWREDSUMU_VS       = 32'b110000???????????000?????1010111;
  localparam logic [31:0] VWREDSUM_VS        = 32'b110001???????????000?????1010111;
  localparam logic [31:0] VADD_VI            = 32'b000000???????????011?????1010111;
  localparam logic [31:0] VRSUB_VI           = 32'b000011???????????011?????1010111;
  localparam logic [31:0] VAND_VI            = 32'b001001???????????011?????1010111;
  localparam logic [31:0] VOR_VI             = 32'b001010???????????011?????1010111;
  localparam logic [31:0] VXOR_VI            = 32'b001011???????????011?????1010111;
  localparam logic [31:0] VRGATHER_VI        = 32'b001100???????????011?????1010111;
  localparam logic [31:0] VSLIDEUP_VI        = 32'b001110???????????011?????1010111;
  localparam logic [31:0] VSLIDEDOWN_VI      = 32'b001111???????????011?????1010111;
  localparam logic [31:0] VADC_VIM           = 32'b0100000??????????011?????1010111;
  localparam logic [31:0] VMADC_VIM          = 32'b0100010??????????011?????1010111;
  localparam logic [31:0] VMADC_VI           = 32'b0100011??????????011?????1010111;
  localparam logic [31:0] VMERGE_VIM         = 32'b0101110??????????011?????1010111;
  localparam logic [31:0] VMV_V_I            = 32'b010111100000?????011?????1010111;
  localparam logic [31:0] VMSEQ_VI           = 32'b011000???????????011?????1010111;
  localparam logic [31:0] VMSNE_VI           = 32'b011001???????????011?????1010111;
  localparam logic [31:0] VMSLEU_VI          = 32'b011100???????????011?????1010111;
  localparam logic [31:0] VMSLE_VI           = 32'b011101???????????011?????1010111;
  localparam logic [31:0] VMSGTU_VI          = 32'b011110???????????011?????1010111;
  localparam logic [31:0] VMSGT_VI           = 32'b011111???????????011?????1010111;
  localparam logic [31:0] VSADDU_VI          = 32'b100000???????????011?????1010111;
  localparam logic [31:0] VSADD_VI           = 32'b100001???????????011?????1010111;
  localparam logic [31:0] VSLL_VI            = 32'b100101???????????011?????1010111;
  localparam logic [31:0] VMV1R_V            = 32'b1001111?????00000011?????1010111;
  localparam logic [31:0] VMV2R_V            = 32'b1001111?????00001011?????1010111;
  localparam logic [31:0] VMV4R_V            = 32'b1001111?????00011011?????1010111;
  localparam logic [31:0] VMV8R_V            = 32'b1001111?????00111011?????1010111;
  localparam logic [31:0] VSRL_VI            = 32'b101000???????????011?????1010111;
  localparam logic [31:0] VSRA_VI            = 32'b101001???????????011?????1010111;
  localparam logic [31:0] VSSRL_VI           = 32'b101010???????????011?????1010111;
  localparam logic [31:0] VSSRA_VI           = 32'b101011???????????011?????1010111;
  localparam logic [31:0] VNSRL_WI           = 32'b101100???????????011?????1010111;
  localparam logic [31:0] VNSRA_WI           = 32'b101101???????????011?????1010111;
  localparam logic [31:0] VNCLIPU_WI         = 32'b101110???????????011?????1010111;
  localparam logic [31:0] VNCLIP_WI          = 32'b101111???????????011?????1010111;
  localparam logic [31:0] VREDSUM_VS         = 32'b000000???????????010?????1010111;
  localparam logic [31:0] VREDAND_VS         = 32'b000001???????????010?????1010111;
  localparam logic [31:0] VREDOR_VS          = 32'b000010???????????010?????1010111;
  localparam logic [31:0] VREDXOR_VS         = 32'b000011???????????010?????1010111;
  localparam logic [31:0] VREDMINU_VS        = 32'b000100???????????010?????1010111;
  localparam logic [31:0] VREDMIN_VS         = 32'b000101???????????010?????1010111;
  localparam logic [31:0] VREDMAXU_VS        = 32'b000110???????????010?????1010111;
  localparam logic [31:0] VREDMAX_VS         = 32'b000111???????????010?????1010111;
  localparam logic [31:0] VAADDU_VV          = 32'b001000???????????010?????1010111;
  localparam logic [31:0] VAADD_VV           = 32'b001001???????????010?????1010111;
  localparam logic [31:0] VASUBU_VV          = 32'b001010???????????010?????1010111;
  localparam logic [31:0] VASUB_VV           = 32'b001011???????????010?????1010111;
  localparam logic [31:0] VMV_X_S            = 32'b0100001?????00000010?????1010111;
  localparam logic [31:0] VZEXT_VF8          = 32'b010010??????00010010?????1010111;
  localparam logic [31:0] VSEXT_VF8          = 32'b010010??????00011010?????1010111;
  localparam logic [31:0] VZEXT_VF4          = 32'b010010??????00100010?????1010111;
  localparam logic [31:0] VSEXT_VF4          = 32'b010010??????00101010?????1010111;
  localparam logic [31:0] VZEXT_VF2          = 32'b010010??????00110010?????1010111;
  localparam logic [31:0] VSEXT_VF2          = 32'b010010??????00111010?????1010111;
  localparam logic [31:0] VCOMPRESS_VM       = 32'b0101111??????????010?????1010111;
  localparam logic [31:0] VMANDN_MM          = 32'b011000???????????010?????1010111;
  localparam logic [31:0] VMAND_MM           = 32'b011001???????????010?????1010111;
  localparam logic [31:0] VMOR_MM            = 32'b011010???????????010?????1010111;
  localparam logic [31:0] VMXOR_MM           = 32'b011011???????????010?????1010111;
  localparam logic [31:0] VMORN_MM           = 32'b011100???????????010?????1010111;
  localparam logic [31:0] VMNAND_MM          = 32'b011101???????????010?????1010111;
  localparam logic [31:0] VMNOR_MM           = 32'b011110???????????010?????1010111;
  localparam logic [31:0] VMXNOR_MM          = 32'b011111???????????010?????1010111;
  localparam logic [31:0] VMSBF_M            = 32'b010100??????00001010?????1010111;
  localparam logic [31:0] VMSOF_M            = 32'b010100??????00010010?????1010111;
  localparam logic [31:0] VMSIF_M            = 32'b010100??????00011010?????1010111;
  localparam logic [31:0] VIOTA_M            = 32'b010100??????10000010?????1010111;
  localparam logic [31:0] VID_V              = 32'b010100?0000010001010?????1010111;
  localparam logic [31:0] VCPOP_M            = 32'b010000??????10000010?????1010111;
  localparam logic [31:0] VFIRST_M           = 32'b010000??????10001010?????1010111;
  localparam logic [31:0] VDIVU_VV           = 32'b100000???????????010?????1010111;
  localparam logic [31:0] VDIV_VV            = 32'b100001???????????010?????1010111;
  localparam logic [31:0] VREMU_VV           = 32'b100010???????????010?????1010111;
  localparam logic [31:0] VREM_VV            = 32'b100011???????????010?????1010111;
  localparam logic [31:0] VMULHU_VV          = 32'b100100???????????010?????1010111;
  localparam logic [31:0] VMUL_VV            = 32'b100101???????????010?????1010111;
  localparam logic [31:0] VMULHSU_VV         = 32'b100110???????????010?????1010111;
  localparam logic [31:0] VMULH_VV           = 32'b100111???????????010?????1010111;
  localparam logic [31:0] VMADD_VV           = 32'b101001???????????010?????1010111;
  localparam logic [31:0] VNMSUB_VV          = 32'b101011???????????010?????1010111;
  localparam logic [31:0] VMACC_VV           = 32'b101101???????????010?????1010111;
  localparam logic [31:0] VNMSAC_VV          = 32'b101111???????????010?????1010111;
  localparam logic [31:0] VWADDU_VV          = 32'b110000???????????010?????1010111;
  localparam logic [31:0] VWADD_VV           = 32'b110001???????????010?????1010111;
  localparam logic [31:0] VWSUBU_VV          = 32'b110010???????????010?????1010111;
  localparam logic [31:0] VWSUB_VV           = 32'b110011???????????010?????1010111;
  localparam logic [31:0] VWADDU_WV          = 32'b110100???????????010?????1010111;
  localparam logic [31:0] VWADD_WV           = 32'b110101???????????010?????1010111;
  localparam logic [31:0] VWSUBU_WV          = 32'b110110???????????010?????1010111;
  localparam logic [31:0] VWSUB_WV           = 32'b110111???????????010?????1010111;
  localparam logic [31:0] VWMULU_VV          = 32'b111000???????????010?????1010111;
  localparam logic [31:0] VWMULSU_VV         = 32'b111010???????????010?????1010111;
  localparam logic [31:0] VWMUL_VV           = 32'b111011???????????010?????1010111;
  localparam logic [31:0] VWMACCU_VV         = 32'b111100???????????010?????1010111;
  localparam logic [31:0] VWMACC_VV          = 32'b111101???????????010?????1010111;
  localparam logic [31:0] VWMACCSU_VV        = 32'b111111???????????010?????1010111;
  localparam logic [31:0] VAADDU_VX          = 32'b001000???????????110?????1010111;
  localparam logic [31:0] VAADD_VX           = 32'b001001???????????110?????1010111;
  localparam logic [31:0] VASUBU_VX          = 32'b001010???????????110?????1010111;
  localparam logic [31:0] VASUB_VX           = 32'b001011???????????110?????1010111;
  localparam logic [31:0] VMV_S_X            = 32'b010000100000?????110?????1010111;
  localparam logic [31:0] VSLIDE1UP_VX       = 32'b001110???????????110?????1010111;
  localparam logic [31:0] VSLIDE1DOWN_VX     = 32'b001111???????????110?????1010111;
  localparam logic [31:0] VDIVU_VX           = 32'b100000???????????110?????1010111;
  localparam logic [31:0] VDIV_VX            = 32'b100001???????????110?????1010111;
  localparam logic [31:0] VREMU_VX           = 32'b100010???????????110?????1010111;
  localparam logic [31:0] VREM_VX            = 32'b100011???????????110?????1010111;
  localparam logic [31:0] VMULHU_VX          = 32'b100100???????????110?????1010111;
  localparam logic [31:0] VMUL_VX            = 32'b100101???????????110?????1010111;
  localparam logic [31:0] VMULHSU_VX         = 32'b100110???????????110?????1010111;
  localparam logic [31:0] VMULH_VX           = 32'b100111???????????110?????1010111;
  localparam logic [31:0] VMADD_VX           = 32'b101001???????????110?????1010111;
  localparam logic [31:0] VNMSUB_VX          = 32'b101011???????????110?????1010111;
  localparam logic [31:0] VMACC_VX           = 32'b101101???????????110?????1010111;
  localparam logic [31:0] VNMSAC_VX          = 32'b101111???????????110?????1010111;
  localparam logic [31:0] VWADDU_VX          = 32'b110000???????????110?????1010111;
  localparam logic [31:0] VWADD_VX           = 32'b110001???????????110?????1010111;
  localparam logic [31:0] VWSUBU_VX          = 32'b110010???????????110?????1010111;
  localparam logic [31:0] VWSUB_VX           = 32'b110011???????????110?????1010111;
  localparam logic [31:0] VWADDU_WX          = 32'b110100???????????110?????1010111;
  localparam logic [31:0] VWADD_WX           = 32'b110101???????????110?????1010111;
  localparam logic [31:0] VWSUBU_WX          = 32'b110110???????????110?????1010111;
  localparam logic [31:0] VWSUB_WX           = 32'b110111???????????110?????1010111;
  localparam logic [31:0] VWMULU_VX          = 32'b111000???????????110?????1010111;
  localparam logic [31:0] VWMULSU_VX         = 32'b111010???????????110?????1010111;
  localparam logic [31:0] VWMUL_VX           = 32'b111011???????????110?????1010111;
  localparam logic [31:0] VWMACCU_VX         = 32'b111100???????????110?????1010111;
  localparam logic [31:0] VWMACC_VX          = 32'b111101???????????110?????1010111;
  localparam logic [31:0] VWMACCUS_VX        = 32'b111110???????????110?????1010111;
  localparam logic [31:0] VWMACCSU_VX        = 32'b111111???????????110?????1010111;
  localparam logic [31:0] VAMOSWAPEI8_V      = 32'b00001????????????000?????0101111;
  localparam logic [31:0] VAMOADDEI8_V       = 32'b00000????????????000?????0101111;
  localparam logic [31:0] VAMOXOREI8_V       = 32'b00100????????????000?????0101111;
  localparam logic [31:0] VAMOANDEI8_V       = 32'b01100????????????000?????0101111;
  localparam logic [31:0] VAMOOREI8_V        = 32'b01000????????????000?????0101111;
  localparam logic [31:0] VAMOMINEI8_V       = 32'b10000????????????000?????0101111;
  localparam logic [31:0] VAMOMAXEI8_V       = 32'b10100????????????000?????0101111;
  localparam logic [31:0] VAMOMINUEI8_V      = 32'b11000????????????000?????0101111;
  localparam logic [31:0] VAMOMAXUEI8_V      = 32'b11100????????????000?????0101111;
  localparam logic [31:0] VAMOSWAPEI16_V     = 32'b00001????????????101?????0101111;
  localparam logic [31:0] VAMOADDEI16_V      = 32'b00000????????????101?????0101111;
  localparam logic [31:0] VAMOXOREI16_V      = 32'b00100????????????101?????0101111;
  localparam logic [31:0] VAMOANDEI16_V      = 32'b01100????????????101?????0101111;
  localparam logic [31:0] VAMOOREI16_V       = 32'b01000????????????101?????0101111;
  localparam logic [31:0] VAMOMINEI16_V      = 32'b10000????????????101?????0101111;
  localparam logic [31:0] VAMOMAXEI16_V      = 32'b10100????????????101?????0101111;
  localparam logic [31:0] VAMOMINUEI16_V     = 32'b11000????????????101?????0101111;
  localparam logic [31:0] VAMOMAXUEI16_V     = 32'b11100????????????101?????0101111;
  localparam logic [31:0] VAMOSWAPEI32_V     = 32'b00001????????????110?????0101111;
  localparam logic [31:0] VAMOADDEI32_V      = 32'b00000????????????110?????0101111;
  localparam logic [31:0] VAMOXOREI32_V      = 32'b00100????????????110?????0101111;
  localparam logic [31:0] VAMOANDEI32_V      = 32'b01100????????????110?????0101111;
  localparam logic [31:0] VAMOOREI32_V       = 32'b01000????????????110?????0101111;
  localparam logic [31:0] VAMOMINEI32_V      = 32'b10000????????????110?????0101111;
  localparam logic [31:0] VAMOMAXEI32_V      = 32'b10100????????????110?????0101111;
  localparam logic [31:0] VAMOMINUEI32_V     = 32'b11000????????????110?????0101111;
  localparam logic [31:0] VAMOMAXUEI32_V     = 32'b11100????????????110?????0101111;
  localparam logic [31:0] VAMOSWAPEI64_V     = 32'b00001????????????111?????0101111;
  localparam logic [31:0] VAMOADDEI64_V      = 32'b00000????????????111?????0101111;
  localparam logic [31:0] VAMOXOREI64_V      = 32'b00100????????????111?????0101111;
  localparam logic [31:0] VAMOANDEI64_V      = 32'b01100????????????111?????0101111;
  localparam logic [31:0] VAMOOREI64_V       = 32'b01000????????????111?????0101111;
  localparam logic [31:0] VAMOMINEI64_V      = 32'b10000????????????111?????0101111;
  localparam logic [31:0] VAMOMAXEI64_V      = 32'b10100????????????111?????0101111;
  localparam logic [31:0] VAMOMINUEI64_V     = 32'b11000????????????111?????0101111;
  localparam logic [31:0] VAMOMAXUEI64_V     = 32'b11100????????????111?????0101111;
  ...
  localparam logic [31:0] FLB                = 32'b?????????????????100?????0000111;
  localparam logic [31:0] FSB                = 32'b?????????????????100?????0100111;
